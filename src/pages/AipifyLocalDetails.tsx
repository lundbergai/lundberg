...
import { ArrowLeft, Users, User, ExternalLink, Building2, X } from 'lucide-react';
...
const AipifyLocalDetails = () => {
	const project = projectsData.find(p => p.slug === "aipifylocal");
...
export default AipifyLocalDetails;
